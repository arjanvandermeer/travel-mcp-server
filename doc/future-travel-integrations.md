...
3. Expose cached fields in `get_poi_details` and MCP App widgets.
...
4. Keep route data out of the core service until there is a separately approved product requirement.

## Decision

Wikidata and route planning belong as optional enrichment/integration layers:

- Wikidata: cached enrichment for POI details and MCP App widgets.
- Routing: a future provider-backed integration, separate from core search.
