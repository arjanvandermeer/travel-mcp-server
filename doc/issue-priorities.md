...
| --- | --- | --- |
| [#25 Make schema initialization non-destructive by default](https://github.com/arjanvandermeer/travel-mcp-server/issues/25) | Prevents accidental data loss and affects setup docs, migrations, and local/prod safety. | Split dev reset from safe bootstrap, then update `README.md` and `doc/getting-started.md`. |
